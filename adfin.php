#! /usr/bin/php
<?php
//Tambahin dengan wordlist pribadimu
echo "[ =========================================================================== ]\n";
	echo " -->
──────────────── ────██
────────────────────█─░█
...
<--\n";
	echo "                 >>>>> ADMIN FINDER <<<<<<\n";
	echo "-->          usage: php namafile.php http://site.com ewe           <--\n";
	echo "[ =========================================================================== ]\n\n";
$sule = array();
function run($array,$jembod){
	for($i = 0;$i < count($array); $i++){
		$url = $jembod."/".urlencode($array[$i]);
